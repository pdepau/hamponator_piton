...
class SimpleSubscriber(Node):
    ...
    def listener_callback(self, msg):
        #cv2.waitKey(0)
        print(msg)
        resultado = PublisherFoto.predict('src/hamponator/hamponator_ia/hamponator_ia/foto2.jpg')
        time.sleep(1)
        mensaje = String()
    ...
    def camera_callback(self,data):
        ...
        try:
            ...
            cv2.imwrite('src/hamponator/hamponator_ia/hamponator_ia/foto2.jpg', cv_image)
